      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">AutoGram</span>
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="bg-indigo-50 text-indigo-700 rounded-lg px-4 py-3 text-sm mb-6">
            <strong>Demo:</strong> demo@autogram.com.br / demo123
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Não tem conta?{' '}
            <Link href="/cadastrar" className="text-indigo-600 font-medium hover:underline">
              Cadastre-se grátis
            </Link>
          </p>
        </div>
